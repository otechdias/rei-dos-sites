                ...
                <div className={styles.content}>
                    <div className={styles.texts}>
                        ...
                        <div className={styles.title}>
                            <h3 style={{ color }}>
                                Programação do zero ao pro
                            </h3>
                        </div>
                        <div className={styles.body}>
                            <h5 style={{ color }}>
                                Aprenda conceitos fundamentais e avançados de
                                programação, com técnicas práticas para
                                construir projetos sólidos. Com nossos cursos,
                                você adquirirá as habilidades necessárias para
