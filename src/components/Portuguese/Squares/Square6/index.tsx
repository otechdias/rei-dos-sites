                            ...
                            <div className={styles.content}>
                                <div className={styles.texts}>
                                    ...
                                    <div className={styles.body}>
                                        <h5 style={{ color }}>
                                            Domine o GitHub! Aprenda a gerenciar
                                            projetos, versionar seu código e
                                            colaborar em equipe com facilidade.
                                            Com essas habilidades, você estará
                                            pronto para enfrentar qualquer
